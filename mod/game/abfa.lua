...
function initMod ()
    ...
    menu1:newLink(-6.0,-3.0,"Settings",link("menu3"))
    menu1:newLink(4.0,-3.0,"Exit","exit")
    ...
    local menu3 = window:new ()
    menu3:initMenu("menu3")
    menu3:newText(-6.0,1.0,"Settings")
    menu3:newLink(-6.0,-4.0,"Back","back")
    menu3:newLink(0.0,-4.0,"Defaults", link("defaults"))
