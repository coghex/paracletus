...
indexTTF TextSize30px '-' = TTFData 33  (5.0*chXUnit) (1.0*chYUnit) (6.0*chXUnit)  (1.0*chYUnit)
...
indexTTF TextSize16px '-' = TTFData 127 (5.0*chXUnit) (1.0*chYUnit) (6.0*chXUnit)  (0.0*chYUnit)
...
indexTTF TextSize16px '1' = TTFData 131 (3.0*chXUnit) (7.0*chYUnit) (6.0*chXUnit)  (0.0*chYUnit)
